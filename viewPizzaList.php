...
<body>
    ...
    <div class="container my-3" id="cont">
        ...
        <?php
            $id = $_GET['catid'];
            $sql = "SELECT * FROM `menu` WHERE vadaCategorieId = $id";
            $result = mysqli_query($conn, $sql);
            $noResult = true;
            while($row = mysqli_fetch_assoc($result)){
                $noResult = false;
                ...
                echo '<div class="col-xs-4 col-sm-4 col-md-4 mt-3">
                        <div class="card" style="width: 18rem;">
                            ...
                            echo '</form>                            
                                <a href="viewPizza.php?vadapavId=' . $vadapavId . '" class="mx-2"><button class="btn btn-primary">Quick View</button></a> 
                                </div>
                            </div>
                        </div>
                    </div>';

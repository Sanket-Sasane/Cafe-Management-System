...
echo '<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="background-color: none;">
      <a class="navbar-brand" href="index.php"><img src="img/villains adda.jpg" class="rounded-pill" style="height:100px; width:100px"></a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form method="get" action="/VilliansAdda/search.php" class="form-inline my-2 my-lg-0 mx-3">
        ...
        if($loggedin){
          ...
          echo '
          <a href="admin/login.php"><button type="button" class="btn btn-success mx-2"  data-toggle="modal">Admin</button></a>
